    ...
    <div class="row justify-content-center">
        <div class="col-lg-3 col-md-6 mb-4 d-flex">
            <div class="card w-100">
                <img src="assets/Gondala1.jpg" style="width:100%; height:auto; border-top-left-radius:1rem; border-top-right-radius:1rem;" alt="Luge" fetchpriority="high">
                <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 mb-4 d-flex">
            <div class="card w-100">
                <img src="assets/Gondala3.jpg" style="width:100%; height:auto; border-top-left-radius:1rem; border-top-right-radius:1rem;" alt="Gondala">
                <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 mb-4 d-flex">
            <div class="card w-100">
                <img src="assets/Luge2.jpg" style="width:100%; height:auto; border-top-left-radius:1rem; border-top-right-radius:1rem;" alt="Skyswing">
                <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 mb-4 d-flex">
            <div class="card w-100">
                <img src="assets/Luge1.jpg" style="width:100%; height:auto; border-top-left-radius:1rem; border-top-right-radius:1rem;" alt="Mountain Bike Park">
                <div class="card-body">
